...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsp.ipc", false, filepath.Join(os.TempDir(), "gsp.ipc")},
		{"data", "gsp.ipc", false, "data/gsp.ipc"},
		{"data", "./gsp.ipc", false, "./gsp.ipc"},
		{"data", "/gsp.ipc", false, "/gsp.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsp.ipc", true, `\\.\pipe\gsp.ipc`},
		{"data", "gsp.ipc", true, `\\.\pipe\gsp.ipc`},
		{"data", `\\.\pipe\gsp.ipc`, true, `\\.\pipe\gsp.ipc`},
	}
