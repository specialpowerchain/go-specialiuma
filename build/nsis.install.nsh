Name "gsp ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/specialpowerchain/go-specialiuma/issues"
!define UPDATEURL "https://github.com/specialpowerchain/go-specialiuma/releases"
!define ABOUTURL "https://github.com/specialpowerchain/go-specialiuma#ethereum-go"
...
# Install gsp binary
Section "Gsp" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gsp}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsp.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsp.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gsp incoming peers (TCP:33990)"
  SimpleFC::AdvRemoveRule "Gsp outgoing peers (TCP:33990)"
  SimpleFC::AdvRemoveRule "Gsp UDP discovery (UDP:33990)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsp incoming peers (TCP:33990)" ""  6 1 1 2147483647 1 "$INSTDIR\gsp.exe" "" "" "Ethereum" 33990 "" "" ""
  SimpleFC::AdvAddRule "Gsp outgoing peers (TCP:33990)" ""  6 2 1 2147483647 1 "$INSTDIR\gsp.exe" "" "" "Ethereum" "" 33990 "" ""
  SimpleFC::AdvAddRule "Gsp UDP discovery (UDP:33990)" "" 17 2 1 2147483647 1 "$INSTDIR\gsp.exe" "" "" "Ethereum" "" 33990 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gsp.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gsp.ipc"
